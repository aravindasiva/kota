        ...
        <AuthProvider>
          <CartProvider>
            <div className="flex flex-col min-h-screen relative">
              ...
              <footer className="bg-primary-dark text-neutral py-6 text-center">
                <div className="container mx-auto px-4">
                  <p className="flex items-center justify-center space-x-2 text-sm">
                    ...
                    <span>by</span>
                    <a
                      href="https://github.com/aravindasiva/kota"
                      target="_blank"
